                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    <tr className="border-b text-[#4C4C4C] border-gray-200 odd:bg-white even:bg-[#F6F6F6]">
                      ...
                      <td className="py-6 px-6">01/05/2024</td>
                      ...
                      <td className="py-6 px-6 flex space-x-2">
                        ...
                        <button className="bg-[#F4E9FF] text-[#7A20DA] font-bold flex px-4 items-center gap-2 py-1 rounded-[5px]">
                          ...
                          >
                            <path
                              d="M12.4492 4.54169H16.0742L11.9492 0.416687V4.04169C11.9492 4.33335 12.1576 4.54169 12.4492 4.54169Z"
                              fill="white"
                            />
                            <path
                              d="M10.6992 9.04175L4.44922 15.2917L6.03255 16.8751L12.2826 10.6251L11.4909 9.83341L10.6992 9.04175Z"
                              fill="white"
                            />
                            <path
                              d="M3.9082 17.4168L5.11654 17.2085L4.11654 16.2085L3.9082 17.4168Z"
                              fill="white"
                            />
                            <path
                              d="M12.4089 7.7915C12.2839 7.6665 12.0755 7.6665 11.9505 7.7915L11.3672 8.37484L12.1589 9.1665L12.9505 9.95817L13.5339 9.37484C13.6172 9.2915 13.6172 9.20817 13.6172 9.12484C13.6172 9.0415 13.5755 8.95817 13.5339 8.87484L12.4089 7.7915Z"
                              fill="white"
                            />
                            <path
                              d="M12.4499 5.41667C11.6999 5.41667 11.0749 4.79167 11.0749 4.04167V0H1.61654C1.19987 0 0.908203 0.333333 0.908203 0.708333V19.2917C0.908203 19.6667 1.19987 20 1.61654 20H15.7832C16.1582 20 16.4915 19.6667 16.4915 19.2917V5.41667H12.4499ZM14.1165 10L13.1999 10.9167L6.32487 17.7917C6.2832 17.8333 6.24154 17.875 6.19987 17.875H6.1582H6.11654L3.44987 18.3333C3.4082 18.3333 3.4082 18.3333 3.36654 18.3333C3.24154 18.3333 3.1582 18.2917 3.07487 18.2083C2.99154 18.125 2.94987 17.9583 2.94987 17.8333L3.4082 15.1667V15.125V15.0833C3.44987 15.0417 3.44987 15 3.49154 14.9583L10.3665 8.08333L11.2832 7.16667C11.7415 6.70833 12.5332 6.70833 12.9915 7.16667L14.1165 8.33333C14.3249 8.54167 14.4499 8.875 14.4499 9.16667C14.4915 9.5 14.3665 9.79167 14.1165 10Z"
                              fill="#7A20DA"
                            />
                          </svg>
                          Modifier
                    ...
                    <tr className="border-b border-gray-200 odd:bg-white even:bg-[#F6F6F6]">
                      <td className="py-6 px-6">B. Dubois</td>
                      <td className="py-6 px-6">Commerce</td>
                      <td className="py-6 px-6">20/04/2024</td>
                      <td className="py-6 px-6">Validé</td>
                      <td className="py-6 px-6 flex space-x-2">
                    ...
                    <tr className="border-b border-gray-200 odd:bg-white even:bg-[#F6F6F6]">
                      ...
                      <td className="py-6 px-6">15/04/2024</td>
                    ...
                    <tr className="border-b border-gray-200 odd:bg-white even:bg-[#F6F6F6]">
                      ...
                      <td className="py-6 px-6">Informatique</td>
                      <td className="py-6 px-6">03/03/2024</td>
                      <td className="py-6 px-6">En attente</td>
                      <td className="py-6 px-6 flex space-x-2">
                        <button className="bg-[#7A20DA] text-white px-2 py-1 rounded-md">
                          Valider
